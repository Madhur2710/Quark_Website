...
export default function bottomNavbar(){
    return (
        <div className="absolute h-screen w-screen">
            <h1 className="absolute bottom-[103.5%] left-[6.9%] z-1 text-md md:text-lg lg:text-xl font-bold font-robot-invaders">GUEST LECTURES</h1>
            <h1 className="absolute bottom-[101%] left-[24.2%] z-1 text-sm md:text-md lg:text-lg font-bold font-robot-invaders">MEDIA PARTNERS</h1>
            <h1 className="absolute bottom-[101%] left-[65%] z-1 text-sm md:text-md lg:text-lg font-bold font-robot-invaders">SPONSORS</h1>
            <h1 className="absolute bottom-[103.5%] left-[81.5%] z-1 text-md md:text-lg lg:text-xl font-bold font-robot-invaders">OUR TEAM</h1>
            ...
            <img src={thirdRect} draggable="false" className="absolute bottom-[101%] left-[60.5%] w-[18%]"></img>
