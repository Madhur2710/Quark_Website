...
export default function home(){
    return(
        <div className=" w-screen overflow-hidden h-screen ">
            ...
            <img src={Background} draggable="false" className="absolute w-full h-full z-[-3] "></img>
            <img src={Quarklogo} draggable="false" className="absolute z-1 w-[100%] mt-[3%] md:w-[80%] md:mx-[10%] lg:w-[68%] lg:mx-[16%]  "></img>
            <img src={Astronaut} draggable="false" className="absolute w-[100%] md:w-[80%] md:mx-[10%] lg:w-[56%] lg:mx-[22%] bottom-[0%] z-[-2]"></img>
        </div>
    )
}